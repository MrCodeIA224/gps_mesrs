...
def generer_pdf_conversation(historique: list[dict]) -> bytes:
    ...
    # Caractères typographiques courants absents du Latin-1 utilisé par les
    # polices de base de fpdf2 : on les remplace par un équivalent lisible
    # avant le repli en dernier recours sur l'encodage strict.
    SUBSTITUTIONS = {
        "—": "-", "–": "-", "’": "'", "‘": "'",
        "“": '"', "”": '"', "…": "...", "•": "-",
    }
